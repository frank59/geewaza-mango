package com.geewaza.code.mango.respository.dao.generator;
...
public class MybatisPlusGeneratorMain {
    ...
    private static final String DB_URL = "jdbc:mysql://192.168.10.10:3306/mango";
    private static final String DB_DRIVER = "com.mysql.cj.jdbc.Driver";
    private static final String DB_USER = "mango";
    private static final String DB_PWD = "qwer@1234";
    private static final String BASE_PATH = System.getProperty("user.dir") + "/mango-repository";
    ...
    private static final String BASE_PACKAGE = "com.geewaza.code.mango.repository.dao.auto";
...
//                        .setLogicDeleteFieldName("status")
                // 增加@TableField注解
                        .setTableFillList(Lists.asList(
                                new TableFill("create_time", FieldFill.INSERT),
                                new TableFill[] {new TableFill("update_time", FieldFill.INSERT_UPDATE)}
                        ))
//                        .setRestControllerStyle(true)
                        //.setExclude(new String[]{"test"}) // 排除生成的表
                        // 自定义实体父类
//                        .setSuperEntityClass("com.zdww.cd.amc.hsb.dao.auto.entity.BaseEntity")
                        // 自定义实体，公共字段
